        ...
        <form id="carousel-form" onsubmit="submitCarouselForm(event)">
          ...
          <div class="form-group">
            ...
            <div id="carousel-upload-area"
              ...
              <div id="carousel-upload-preview" style="display:none;margin-bottom:10px;justify-content:center;align-items:center;background:var(--bg-page);border-radius:var(--radius);padding:8px;min-height:120px;">
                <img id="carousel-preview-img" src="" alt="Preview"
                  style="max-width:100%;max-height:320px;width:auto;height:auto;border-radius:var(--radius);display:block;object-fit:contain;" />
              </div>
...
function _carouselRow(b) {
  const previewBg = b.image_url
    ? `background:url('${_escAttr(b.image_url)}') center/contain no-repeat;background-color:var(--bg-page);`
