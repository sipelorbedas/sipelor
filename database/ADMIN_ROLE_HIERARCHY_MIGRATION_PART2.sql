-- ================================================
-- ADMIN ROLE HIERARCHY - PART 2: Update Policies
-- ================================================
-- ⚠️ IMPORTANT: Only run this AFTER PART 1 completes
-- ================================================

-- Step 1: Update CHECK constraint (if using TEXT type instead of ENUM)
DO $$
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'user_role') THEN
    ...
    RAISE NOTICE '✅ Added new profiles_role_check constraint with superadmin';
  ELSE
    RAISE NOTICE 'ℹ️  Column uses enum type - no CHECK constraint needed';
  END IF;
END $$;
...
-- UPDATE profiles 
-- SET role = 'superadmin' 
-- WHERE email = 'bedaşıpelor@gmail.com' AND role = 'admin';
